...
class _SignupPageState extends State<SignupPage> {
  ...
  Future<void> _handleSignup() async {
    ...
    if (_nameController.text.isEmpty ||
        ...
        _isUsernameAvailable != true) return;
    if (_passwordController.text != _confirmPasswordController.text) {
      setState(() => _passwordError = "No match");
      return;
    }
  ...
  Future<void> _checkEmailVerified() async {
    ...
    if (user != null && user.emailVerified) {
      ...
      // --- ONBOARDING LOGIC: CREATE SYSTEM CONTACT ---
      ...
      // 2. Add 'System Admin' to their contacts automatically (Use your UID here)
      // For this example, I'll use a placeholder 'admin_bot'
      String adminId = "SYSTEM_ADMIN";
      DocumentReference contactRef =
          userRef.collection('my_contacts').doc(adminId);
      batch.set(contactRef, {'uid': adminId});

      // 3. Send a Welcome Message
      DocumentReference recentRef =
          userRef.collection('recent_chats').doc(adminId);
      batch.set(recentRef, {
        'name': 'GrindChat Support',
        'lastMessage': 'Welcome! Start grinding by adding friends.',
          ...
          child: SingleChildScrollView(
            ...
            child: Column(children: [
              ...
              if (!_isEmailSent) ...[
                    ...
                    suffix: _isCheckingUsername
                        ? const SizedBox(
                            ...
                            child: CircularProgressIndicator(
                                strokeWidth: 2, color: Color(0xFF8E2DE2)))
                        : (_isUsernameAvailable == true
                ...
                const SizedBox(height: 15),
                _buildTextField(
                    "Confirm Password", "Repeat", _confirmPasswordController,
                    isPassword: true,
                ...
                GestureDetector(
                    onTap: (_isLoading || _isCheckingUsername)
                        ? null
                        : _handleSignup,
                    child: _buildBtn("Sign Up")),
              ] else ...[
                const Icon(Icons.mark_email_unread_outlined,
                    color: Color(0xFF8E2DE2), size: 80),
                const SizedBox(height: 20),
                Text("Verify Email",
                    style: GoogleFonts.poppins(
                        fontSize: 24,
                ...
                Text("Check your inbox: ${_emailController.text}",
  ...
  Widget _buildBtn(String t) => Container(
          ...
          child: _isLoading
              ...
              : Text(t,
                  style: const TextStyle(
                      ...
                      fontSize: 17,
                      fontWeight: FontWeight.bold))));
  Widget _buildTextField(String l, String h, TextEditingController c,
