...
class _ChatDetailPageState extends State<ChatDetailPage> {
  ...
  void _resetUnreadCount() {
    FirebaseFirestore.instance
        ...
        .update({'unreadCount': 0}).catchError(
            (e) => debugPrint("Summary init"));
  }
  ...
  void _saveMsg(
    ...
    String displayMsg =
        type == 'image' ? "📷 Photo" : (type == 'video' ? "🎥 Video" : msg);
  ...
  Future<void> _pickMedia(bool isV) async {
    ...
    var url = Uri.parse(
        "https://api.cloudinary.com/v1_1/$cloudName/${isV ? 'video' : 'image'}/upload");
                    ...
                    children: [
                      ...
                      Row(mainAxisSize: MainAxisSize.min, children: [
                        ...
                        if (widget.isMe) ...[
                          ...
                          _buildTick(widget.isPending, widget.isReceived,
                              widget.isRead)
                        ]
                      ]),
    ...
    if (s)
      return ShaderMask(
          shaderCallback: (b) => const LinearGradient(
              colors: [Color(0xFFD633FF), Color(0xFF00D2FF)]).createShader(b),
